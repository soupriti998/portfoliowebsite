...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, paddingTop: 0, paddingBottom: 'var(--space-10)' }}>
        <div style={{ maxWidth: 780, marginInline: '0', textAlign: 'left' }}>
          ...
          >
            Designing thoughtful<br />
            <span style={{ color: 'var(--accent)' }}>digital experiences</span><br />
            that feel human.
          </h1>
